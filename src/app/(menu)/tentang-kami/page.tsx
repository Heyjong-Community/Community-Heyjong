    ...
    <div>
      ...
      <section id='story' className='px-5 py-24'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8'>
          ...
          <div className=''>
            <p className={`uppercase text-primary text-lg font-bold ${fraunces.className}`}>Tentang Kami</p>
            <h2 className='text-3xl md:text-4xl lg:text-6xl font-bold text-black'>Perjalanan Kami</h2>
            <p className={`mt-6 text-black text-base lg:text-lg font-medium text-justify`}>
      ...
      <section className='bg-[url(/images/about2.JPG)] w-full bg-cover bg-bottom bg-no-repeat'>
        <div className='bg-linear-to-l from-black via-black/50 to-transparent w-full h-full px-5 py-24'>
          <div className='container mx-auto grid grid-cols-1 md:grid-cols-2'>
            <div className=''></div>
            <div className='p-5'>
              <p className={`uppercase text-white text-lg font-bold ${fraunces.className}`}>Visi Kami</p>
              <h2 className='text-3xl md:text-4xl lg:text-6xl font-bold text-white'>Dari Potensi Ke Aksi</h2>
              <p className={`mt-6 text-white text-base lg:text-lg font-medium`}>
      ...
      <section className='px-5 py-24'>
        <div className='text-center'>
          <p className={`uppercase text-primary text-lg font-bold ${fraunces.className}`}>Misi Kami</p>
          <h2 className='text-black text-3xl md:text-4xl lg:text-5xl font-bold'>Kreator Kritis, Aktif, Berdampak</h2>
        </div>
        ...
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8'>
          <div className='flex items-center py-5'>
            <div className=''>
              ...
              <h2 className='font-bold text-3xl lg:text-4xl text-primary'>#LetsSpreadGoodVibes</h2>
            </div>
          </div>
          <div className='py-5'>
            ...
            <div className='mt-4 grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div className='border-2 border-primary rounded-lg p-4'>
                ...
                <p className={`text-black font-medium`}>Responsif, Adaptif, dan Kreatif.</p>
              </div>
              <div className='border-2 border-primary rounded-lg p-4'>
                <h4 className='text-primary text-xl md:text-2xl lg:text-3xl font-bold'>Amanah</h4>
                <p className={`text-black font-medium`}>Bertanggung jawab dalam menjalankan tugas.</p>
              </div>
              <div className='border-2 border-primary rounded-lg p-4'>
                <h4 className='text-primary text-xl md:text-2xl lg:text-3xl font-bold'>Shidiq</h4>
                <p className={`text-black font-medium`}>Selaras antara pemikiran, keyakinan, ucapan, dan perbuatan.</p>
              </div>
              <div className='border-2 border-primary rounded-lg p-4'>
      ...
      <section className='px-5 py-24'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8'>
          <div className=''>
            <p className={`uppercase text-primary text-lg font-bold ${fraunces.className}`}>JONGERS</p>
            <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold text-black'>Let&apos;s Join With Us</h2>
            <p className={`mt-6 text-black text-base lg:text-lg`}>
            ...
            <Link href={`/tentang-kami/jongers`}>
              <button className='mt-6 cursor-pointer font-medium text-xs md:text-sm lg:text-lg bg-[#DF334D] text-white px-6 py-1 rounded-md '>
                Lihat Jongers
              </button>
            </Link>
          </div>
