    ...
    <div className=''>
      ...
      <section className='container px-5 py-24 mx-auto'>
        <div className='text-center'>
          ...
          <h2 className='text-black text-xl md:text-3xl lg:text-4xl font-bold'>Heyjong Community</h2>
        </div>
      ...
      <section className='container px-5 py-24 mx-auto'>
        <div className='text-center'>
          ...
          <h2 className='text-black text-xl md:text-3xl lg:text-4xl font-bold'>Yuk Kepoin Keseruannya!</h2>
        </div>
      ...
      <section className='container px-5 py-24 mx-auto'>
        <div className='text-center'>
          ...
          <h2 className='text-black text-xl md:text-3xl lg:text-4xl font-bold'>Jangan Ketinggalan, Follow Sekarang!</h2>
        </div>
        <div className='mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
      ...
      <section className="bg-[url('/images/jongcamp.webp')] bg-cover bg-bottom">
        <div className='py-32 flex items-center justify-center bg-black/50'>
          <div className=''>
            <h1 className='uppercase text-white text-3xl lg:text-6xl text-center font-bold'>
              Ayo Join Heyjong Community!
            </h1>
            <div className='flex justify-center items-center gap-3'>
              <Link href={`https://heyjong.id/oprecMember`} target='_blank' rel='noopener noreferrer'>
                <button className='mt-6 uppercase cursor-pointer font-semibold text-xs md:text-sm lg:text-base bg-[#DF334D] text-white px-6 py-2 rounded-md '>
                  Gass Join
                </button>
              </Link>
              <Link href={`https://wa.me/62895328310378`} target='_blank' rel='noopener noreferrer'>
                <button className='mt-6 uppercase cursor-pointer font-semibold text-xs md:text-sm lg:text-base bg-white text-black px-6 py-2 rounded-md '>
                  Tanya-tanya Dulu
                </button>
              </Link>
            </div>
